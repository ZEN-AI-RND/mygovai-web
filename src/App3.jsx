      ...
      <div className="max-w-7xl mx-auto mb-12">
        ...
        <div className="text-center mb-8">
          ...
          {/* <h1 className="text-5xl font-bold mb-4 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">
            {getText("ZARA PROTOCOL", "PROTOKOL ZARA")}
          </h1> */}

          <h1 className="text-5xl font-display font-bold mb-4 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent tracking-tight">
  {getText("ZARA PROTOCOL", "PROTOKOL ZARA")}
</h1>
          
          {/* <p className="text-2xl text-gray-300"> */}
          <p className="text-2xl font-sans text-gray-300">
      ...
      <div className="max-w-7xl mx-auto mb-12">
        {/* <h2 className="text-3xl font-bold mb-6 text-center"> */}
          <h2 className="text-3xl font-display font-bold mb-6 text-center tracking-tight">
          ...
          {products.map((product) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="text-xl font-display font-bold mb-2 tracking-tight">{product.name}</h3>
<p className="text-sm font-sans opacity-90 mb-3">{product.power}</p>
                <div className="flex justify-between text-xs">
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-sm opacity-75">{getText("Saved/Year", "Jimat/Tahun")}</div>
                  </div>
                </div>
      ...
      <button
        ...
        aria-label={getText("Scroll to top", "Tatal ke atas")}
      >
