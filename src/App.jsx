...
import { Shield, FileText, Brain, Users, AlertTriangle, TrendingUp, Scale, FileCheck, Clock, DollarSign, Radio, FileSignature, Zap, Database, Lock, ArrowLeft, CheckCircle, Target, Sparkles, Globe, ArrowUp, Server, Eye, BookA, Map, BookSearch, BookOpen, Book } from 'lucide-react';
...
const AIArsenalDashboard = () => {
  ...
  const translations = {
    en: {
      ...
      statsLine: "✅12 AI Agents • ✅RM300K Each • ✅Sovereign & Secure",
      aiSystems: "AI Agents",
      ...
      oneTimeInvestment: "One-time investment • Perpetual license • Full sovereignty",
  ...
  const combos = [
    ...
    },
    {
      id: "combo2",
      name: "AI Sentinel",
      systems: ["AI Contract Agent", "AI FraudGuard Agent", "AI Inspector Agent"],
      cost: "RM900K",
    ...
    },
    {
      id: "combo4",
      name: "AI Oracle",
      systems: ["AI Budget Agent", "AI Forecast Agent", "AI Watch Agent"],
      cost: "RM900K",
  ...
  const deploymentTiers = [
    { name: "🥉 BRONZE", cost: "RM300K", systems: 1, timeline: "4 month", roi: "6 months" },
    { name: "🥈 SILVER", cost: "RM900K", systems: 3, timeline: "12 months", roi: "8 months" },
    { name: "🥇 GOLD", cost: "RM1.8M", systems: 6, timeline: "24 months", roi: "10 months" },
    { name: "💎 PLATINUM", cost: "RM3.6M", systems: 12, timeline: "48 months", roi: "12 months" }
  ];
 ...
 {/* <div className="logo">
      ...
      <span className="logo-text">MyAIGOV</span>
    </div> */}
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-4 mb-4">
            {/* <Sparkles className="w-12 h-12 mr-1 text-purple-400" />
              <h1 className="text-6xl font-extrabold tracking-tight text-white leading-tight">
                <span class="bg-gradient-to-r from-purple-400 via-pink-400 to-orange-400 bg-clip-text text-transparent block mb-1 xs:mb-2 text-shadow-glow">
              {getText('title')}
              </span>
              </h1>
          </div> */}
...
{/* <Sparkles
    className="w-12 h-12 mr-2 text-yellow-400 
    animate-[megaSparkle_1.8s_ease-in-out_infinite]"
  /> */}

    {/* <div className="w-16 h-16 flex items-center justify-center rounded-full bg-yellow-400 drop-shadow-[0_0_25px_rgba(255,209,0,0.8)] animate-pulse">
    <Sparkles className="w-8 h-8 text-white" />
  </div> */}

  {/* <Sparkles className="w-12 h-12 mr-2 text-yellow-400 
  animate-[sparkle_2.5s_ease-in-out_infinite]" /> */}

<div className="w-16 h-16 flex items-center justify-center rounded-full border-4 border-yellow-400 
                  drop-shadow-[0_0_15px_rgba(255,209,0,0.8)] animate-pulse">
  ...
  {/* <div className="w-16 h-16 flex items-center justify-center rounded-full border-4 border-yellow-400
    ...
    <span className="text-yellow-400 text-6xl transform scale-x-[-1]">
      🌙
    </span>
  </div> */}
    ...
    <span className="block">
      ...
      <span className="text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.9)] ml-2">
        AI
          ...
          <h1 className="text-3xl font-bold mb-6 text-center">{getText('subtitle')}
        </h1>
        {/* <h2 className="text-lg xs:text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-slate-100 block">{getText('subtitle')} */}
...
Enabling ministries to work smarter, respond faster and deliver trusted services fully secure, sustainable and sovereign.
      ...
      <div className="max-w-7xl mx-auto mb-12">
        {/* <h2 className="text-3xl font-bold mb-6 text-center">🤖 12 AI Agents
          {getText('aiSystems')}
        </h2> */}

        <h2 className="text-3xl font-bold mb-6 text-center">🤖 12 {getText('aiSystems')}
        </h2>
      ...
      <div className="max-w-7xl mx-auto mb-12">
        <h2 className="text-3xl font-bold mb-6 text-center">💥 POWER SUITES</h2>
      ...
      <div className="max-w-7xl mx-auto mb-12">
        ...
        <div className="grid grid-cols-4 gap-6">
          {deploymentTiers.map((tier, idx) => (
            <div
              key={tier.name}
              className={`rounded-lg p-6 border-4 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl cursor-pointer ${
                idx === 0 ? 'border-orange-400 bg-orange-900/20 hover:bg-orange-900/30' :
                idx === 1 ? 'border-gray-400 bg-gray-900/20 hover:bg-gray-900/30' :
                idx === 2 ? 'border-amber-400 bg-amber-900/20 hover:bg-amber-900/30' :
      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-gradient-to-br from-blue-600 to-purple-600 rounded-lg p-8">
          ...
          <div className="grid grid-cols-3 gap-8">
            ...
            <div>
              <h3 className="text-xl font-bold mb-4 text-green-300">✅ MyGOV AI WAY</h3>
              <ul className="space-y-2 text-sm">
            ...
            <div>
              <h3 className="text-xl font-bold mb-4 text-blue-300">🎤 FINAL WORD</h3>
              <ul className="space-y-2 text-sm">
